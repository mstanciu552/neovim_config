...
_G.packer_plugins = {
  ...
  ["alpha-nvim"] = {
    ...
    loaded = true,
    path = "/home/sc0p3/.local/share/nvim/site/pack/packer/start/alpha-nvim",
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/home/sc0p3/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
  ...
  ["project.nvim"] = {
    loaded = true,
    path = "/home/sc0p3/.local/share/nvim/site/pack/packer/start/project.nvim",
  ...
  ["winbar.nvim"] = {
    loaded = true,
    path = "/home/sc0p3/.local/share/nvim/site/pack/packer/start/winbar.nvim",
